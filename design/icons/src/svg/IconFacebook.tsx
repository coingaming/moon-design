...
const Svg = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path
      d="M13.793 20v-7.735h2.61l.39-3.027h-3V7.31c0-.876.245-1.469 1.5-1.469h1.603V3.138a22.14 22.14 0 0 0-2.327-.117c-2.307 0-3.88 1.407-3.88 3.99v2.227H8.087v3.027h2.604V20h3.103z"
      fill="currentColor"
    />
  </svg>
);
...
export const IconFacebook = styled(Svg)<IconProps>(
