...
```jsx react-live
<Stack>
  <Caption rightAlign>Caption renders Span tag by default</Caption>
  <Caption rightAlign as="p">
    آراء وتحليلات
  </Caption>
  <Caption rightAlign color="piccolo.100">
    Caption with defined color
  </Caption>
  <Caption rightAlign color="krillin.100">
    آراء وتحليلات
  </Caption>
</Stack>
```
