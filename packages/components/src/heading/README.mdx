...
We have predefined font sizes: 16 | 18 | 20 | 24 | 32 | 48 | 56 | 64 | 72 rems. Line heights are calculated automatically based on font size.
...
<Stack>
  ...
  <Heading size={18}>Text with font-size: 18rem</Heading>
  <Heading size={20}>Text with font-size: 20rem</Heading>
  <Heading size={24}>Text with font-size: 24rem</Heading>
  <Heading size={32}>Text with font-size: 32rem</Heading>
  <Heading size={48}>font-size: 48rem</Heading>
  <Heading size={56}>font-size: 56rem</Heading>
  <Heading size={64}>font-size: 64rem</Heading>
  <Heading size={72}>font-size: 72rem</Heading>
</Stack>
```
