  ...
  return (
    <div
      ...
      className={classNames(
        ...
        isSelected ? 'text-popo bg-[#e0e0ed]' : fontColor ? `text-${fontColor}` : 'text-popo',
        ...
        selectable ? 'pl-2 text-bulma border-t-1 border-t-transparent border-b-1 border-b-transparent bg-[#e0e0ed]' : ''
      )}
