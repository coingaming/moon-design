...
const Drawer: React.FC<DrawerProps> = ({
  ...
  return (<div>
    {isOpen && (<div
      className='flex fixed top-0 left-0 h-[100vh] w-full justify-end items-stretch z-10 cursor-pointer '
    ...
    <div
      ...
      className={`w-[${width}vw] h-[${height}vh] flex flex-col items-stretch justify-between bg-white z-[99] fixed ease-in-out duration-300 top-0 left-[100%] shadow-xl z-20 ${
