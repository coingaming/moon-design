                  ...
                  <Tab as={Fragment}>
                    {({ selected }) => (
                      <button
                        className={
                          selected
                            ? 'border border-l-piccolo border-y-0 border-r-0 text-piccolo px-3 py-2 text-left ring-transparent focus:outline-none'
                  ...
                  <Tab as={Fragment}>
                    {({ selected }) => (
                      <button
                        className={
                          selected
                            ? 'border border-r-piccolo border-y-0 border-l-0 text-piccolo px-3 py-2 text-left ring-transparent focus:outline-none'
                            : 'text-black px-3 py-2 hover:text-piccolo hover:bg-beerus hover:rounded-lg text-left'
                        }
                      >
                        <p className="leading-6 left-3"> {item} </p>
