...
const ExperienceCarouselItem = ({
  ...
  return (<div className={`w-[276px] h-full ${ backgroundColor ? `bg-${backgroundColor}` : 'bg-gohan' } rounded-lg flex flex-col px-5 pt-5 pb-6 sm:my-8 sm:h-auto ${index && index % 2 ? 'sm:mt-[40%]' : ''}`}>
