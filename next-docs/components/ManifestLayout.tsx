...
const ManifestLayout = ({ children }: {
  ...
  return (<div className={`support-colors bg-background flex rounded-tl-3xl rounded-tr-3xl`}>
    ...
    <div className="min-h-screen flex-1 mx-auto w-0 flex flex-col bg-black lg:pl-16 xl:pl-32">
      ...
      <main className="flex flex-col flex-1 relative overflow-y-auto focus:outline-none">
        ...
        <div className="py-6 px-4 md:px-16 lg:px-0 grow flex flex-col">{children}</div>
      </main>
    </div>
  </div>);
};
