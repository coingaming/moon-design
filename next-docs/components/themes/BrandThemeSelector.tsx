...
const BrandThemeSelector = ({ setBrand, themeKeys }) => {
  ...
  return (
    <>
      <button
        ...
        type="button"
        aria-pressed="false"
        className="text-bulma bg-gohan hover:bg-gohan-80 fixed bottom-4 right-4 inline-flex flex-shrink-0 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none"
      >
        <svg
          width="32"
          height="32"
