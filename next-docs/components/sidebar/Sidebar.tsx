...
const Sidebar = () => {
  ...
  return (
    <div className="theme-moon-light theme-tokens relative z-10 fixed top-0 h-screen w-80 flex flex-col flex-grow gap-10 pt-12 pb-6 px-5 lg:px-8 bg-goku overflow-y-scroll">
