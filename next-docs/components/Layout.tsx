...
const Layout = ({ children }: Props) => {
  ...
  return (
    <div className="theme-moon-light support-colors theme-tokens bg-goku flex">
      ...
      <div className="theme-moon-light min-h-screen bg-gohan flex-1 w-0 flex flex-col lg:rounded-tl-3xl lg:rounded-bl-3xl px-5 xl:px-20 2xl:px-32 lg:pt-12 lg:pb-8">
