...
import {DevicesJoystick, GenericLoyalty, TravelAirplane, TravelBill } from '@heathmont/moon-icons-tw';
...
const Example = () => {
  ...
  return (
    <div className="w-94 bg-white flex flex-col gap-3 rounded-moon-s-lg p-6">
      <MenuItem width="w-[328px]" isActive={activeOpt}>
        <span className='bg-piccolo/20 rounded-lg w-10 h-10 flex justify-center items-center' >
          <TravelAirplane className="text-[1.5rem]" color='#4E46B4' />
        </span>
        <MenuItem.MultiTitle
          title="Job Board"
          text={
      ...
      <hr className='w-[328px] border-px border-solid border-beerus left-6 top-40  self-stretch' />
      <MenuItem width="w-[328px]">
        <span className='bg-[#FFB3191F]/20 rounded-lg w-10 h-10 flex justify-center items-center'>
          <GenericLoyalty className="text-[1.5rem]" color='#FFB319' />
        </span>
        <MenuItem.MultiTitle
      ...
      <MenuItem width="w-[328px]">
        <span className='bg-[#FF4E641F]/20 rounded-lg w-10 h-10 flex justify-center items-center'>
          <DevicesJoystick className="text-[1.5rem]" color='#FF4E64' />
        </span>
        <MenuItem.MultiTitle
