...
const Hero = ({
  ...
  return (<div
    className={`flex flex-col justify-center items-center relative h-[800px] bg-bottom ${ wrapperClasses ? wrapperClasses : ''} sm:flex-row-reverse sm:items-stretch sm:mb-0`}
